...
import com.example.ru_foody.SendNotification.Client;
import com.example.ru_foody.SendNotification.Data;
import com.example.ru_foody.SendNotification.MyResponse;
import com.example.ru_foody.SendNotification.NotificationSender;
...
//                            deliveryId = Shipper.getSelectedItem().toString().trim();
                            ...
                            data.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    assert chef != null;
                                    final String ChefName = chef.getFname();
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Log.d("DebugFoody", "ChefOrders: " + dataSnapshot);
                ChefFinalOrders1 chefFinalOrders1 = dataSnapshot.getValue(ChefFinalOrders1.class);
                grandtotal.setText("Ksh" + chefFinalOrders1.getGrandTotalPrice());
                Shipper.getSelectedItem().toString().trim();
                address.setText(chefFinalOrders1.getAddress());
                name.setText(chefFinalOrders1.getName());
                number.setText("+254" + chefFinalOrders1.getMobileNumber());
    ...
    private void sendNotifications(String usertoken, String title, String message, String prepared) {
        ...
        apiService.sendNotification(sender).enqueue(new Callback<MyResponse>() {
            private Call<MyResponse> call;
            private Response<MyResponse> response;
