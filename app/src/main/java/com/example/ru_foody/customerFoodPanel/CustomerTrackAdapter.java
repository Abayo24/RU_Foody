...
public class CustomerTrackAdapter extends RecyclerView.Adapter<CustomerTrackAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.Quantity.setText(String.format("%s× ", customerFinalOrders.getDishQuantity()));
        holder.Totalprice.setText(String.format("Ksh %s", customerFinalOrders.getTotalPrice()));
