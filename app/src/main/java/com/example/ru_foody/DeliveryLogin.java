...
public class DeliveryLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            login = findViewById(R.id.d_login_btn);
            signup = findViewById(R.id.d_create);
            forgotPassword = findViewById(R.id.df_password);
            ...
            login.setOnClickListener(v -> {
                ...
                if (isValid()){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(DeliveryLogin.this);
...
// Set a custom layout for the dialog
                    ...
                    Fauth.signInWithEmailAndPassword(email_id, password_id).addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            mDialog.dismiss();
                            ReusableCodeForAll.ShowAlert(DeliveryLogin.this, "Error", Objects.requireNonNull(task.getException()).getMessage());
                        }
                    });
                }
            });
