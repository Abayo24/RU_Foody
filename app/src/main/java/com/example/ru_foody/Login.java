...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            email = findViewById(R.id.cu_email);
            password = findViewById(R.id.cu_password);
            login = findViewById(R.id.cu_login_btn);
            signup = findViewById(R.id.cu_create);
            forgotPassword = findViewById(R.id.cuf_password);
                    ...
                    Fauth.signInWithEmailAndPassword(email_id, password_id).addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            if (Objects.requireNonNull(Fauth.getCurrentUser()).isEmailVerified()) {
                                mDialog.dismiss();
                                Toast.makeText(Login.this, "Congratulations You Have Successfully Logged in", Toast.LENGTH_SHORT).show();
